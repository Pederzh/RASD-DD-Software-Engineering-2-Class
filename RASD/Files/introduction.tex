...
\subsection{Purpose}
The main goal of Safestreets is to provide authorities with a tool to control the parking violations. The role of citizens is crucial because they send pictures of violations using the system. Safestreets have to store these information and elaborate it before notify authorities.
...
\subsubsection{Scope}
The scope where Safestreets works is tipically the town enviroment. The main events caused by the world are violations, authorities requiring for statistics and accidents.
The shared phenomena are the photos arriving form users, the notification sending, the presentation of information and statistics and the municipality sending accindents information.  
